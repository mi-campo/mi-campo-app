...
Si es un ANÁLISIS DE AGUA ÚTIL (menciona agua útil, humedad de suelo, mm a cierta profundidad). Puede traer VARIAS LECTURAS en el mismo mensaje, una por lote/pivote — en ese caso listá cada una por separado dentro de "lecturas":
