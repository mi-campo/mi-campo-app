...
CUIDADO — no confundas "puntos de muestreo" con lotes distintos: si el mensaje da varios números que son PUNTOS/MUESTRAS/REPETICIONES dentro de UN MISMO lote ("primer punto", "segundo punto", "punto 1", "punto 2", "muestra A/B") y NO nombra lotes o círculos distintos para cada uno, son TODAS lecturas del mismo lote — repetí el mismo "lote"/"campo" (el único que haya en el mensaje, o null si no lo dieron) en cada elemento de "lecturas", una por cada punto, en vez de inventar un lote distinto por cada número. El sistema ya promedia solo las lecturas de un mismo lote y misma fecha, así que no hace falta que vos calcules el promedio — igual podés incluir la lectura de "promedio" que a veces dan como una lectura más si querés, no rompe nada.
Ejemplo: "Micolini agua útil primer punto 304mm segundo punto 264mm" (sin decir a qué lote) → campo:"Micolini", lecturas:[{"campo":"Micolini","lote":null,"aguaUtilMm":304},{"campo":"Micolini","lote":null,"aguaUtilMm":264}] — con lote:null en ambas, para que el sistema pregunte a qué lote de Micolini corresponde, en vez de adivinar y repartirlas en lotes distintos.
