...
{"tipo":"pulverizacion","fecha":"<fecha del mensaje en formato YYYY-MM-DD si la mencionan, o null si no la dicen>","metodo":"<'Terrestre', 'Drone' o 'Aéreo (avión)' si lo menciona, si no null>","haFacturadas":<hectáreas TOTALES facturadas al contratista (sumando todos los lotes), si las dan, o null>,"tarifaContratista":<USD/ha pagado al contratista, si lo menciona, o null>,"lotes":[{"campo":"<nombre del campo de este lote, o null>","lote":"<nombre/código de este lote>","haReales":<hectáreas reales de ESTE lote en particular si las menciona, o null para usar las hectáreas que ya tiene cargadas el sistema>}],"items":[{"producto":"<nombre del insumo>","cantidadTotal":<numero TOTAL aplicado de ese insumo, sumando todos los lotes>,"unidad":"<L, kg, cc, etc>"}]}
